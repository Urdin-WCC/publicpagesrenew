    ...
    <>
      ...
      <div 
        ...
        style={{
          ...
          paddingTop: 'var(--blog-padding-top, var(--spacing-padding-top, var(--spacing-padding)))',
          paddingBottom: 'var(--blog-padding-bottom, var(--spacing-padding-bottom, var(--spacing-padding)))',
          paddingLeft: 'var(--blog-padding-left, var(--spacing-padding-left, var(--spacing-padding)))',
          paddingRight: 'var(--blog-padding-right, var(--spacing-padding-right, var(--spacing-padding)))',
          marginTop: 'var(--blog-margin-top, var(--spacing-margin-top, var(--spacing-margin, 0)))',
          marginBottom: 'var(--blog-margin-bottom, var(--spacing-margin-bottom, var(--spacing-margin, 0)))',
          marginLeft: 'var(--blog-margin-left, var(--spacing-margin-left, var(--spacing-margin, 0)))',
          marginRight: 'var(--blog-margin-right, var(--spacing-margin-right, var(--spacing-margin, 0)))',
          maxWidth: "100%",
          minHeight: "100%",
          flex: "1 1 auto"
        }}
