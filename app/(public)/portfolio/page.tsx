    ...
    <>
      ...
      <div 
        ...
        style={{
          ...
          paddingTop: 'var(--portfolio-padding-top, var(--spacing-padding-top, var(--spacing-padding)))',
          paddingBottom: 'var(--portfolio-padding-bottom, var(--spacing-padding-bottom, var(--spacing-padding)))',
          paddingLeft: 'var(--portfolio-padding-left, var(--spacing-padding-left, var(--spacing-padding)))',
          paddingRight: 'var(--portfolio-padding-right, var(--spacing-padding-right, var(--spacing-padding)))',
          marginTop: 'var(--portfolio-margin-top, var(--spacing-margin-top, var(--spacing-margin, 0)))',
          marginBottom: 'var(--portfolio-margin-bottom, var(--spacing-margin-bottom, var(--spacing-margin, 0)))',
          marginLeft: 'var(--portfolio-margin-left, var(--spacing-margin-left, var(--spacing-margin, 0)))',
          marginRight: 'var(--portfolio-margin-right, var(--spacing-margin-right, var(--spacing-margin, 0)))',
          maxWidth: "100%",
          minHeight: "100%",
          flex: "1 1 auto"
        }}
