...
export default function CategoryProjectsClient({ categoryId }: CategoryProjectsClientProps) {
  ...
  if (!data || data.projects.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">No se encontraron proyectos en esta categoría.</p>
      </div>
    );
  }
      ...
      {data.totalPages > 1 && (
        <div className="mt-8 flex justify-center">
          <PaginationControls
            ...
            basePath={`/portfolio/category/${searchParams.get('slug')}`}
          />
        </div>
      )}
    </div>
