  ...
  const handleDelete = async (id: string, title: string) => {
    toast.custom((t) => (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 max-w-md mx-auto">
        ...
        <p className="mb-4">{`${translations.admin.portfolioList.deleteConfirm} "${title}"?`}</p>
                  ...
                  <TableBody>
                    {data.projects.map((project) => (
                      <TableRow key={project.id}>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-500">
                                {project.authorDisplayName || project.author?.name || translations.common.unknown}
                              </div>
                            </div>
                          </div>
                        </TableCell>
                        ...
                        <TableCell>
                          {/* Asegurar que project.categories es un array antes de verificar su longitud */}
