...
export default async function SidebarUpdated({ 
  widgets = [],
  config,
  position = 'right',
  className = '',
  ...
  // Ancho personalizado
  const widthClass = sidebarConfig.width || 'w-64';
  ...
  return (
    <>
      ...
      <aside 
        className={`sidebar-component ${sidebarConfig.backgroundColor} ${sidebarConfig.textColor} ${widthClass} p-4 ${positionClasses} ${className}`}
